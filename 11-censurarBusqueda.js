function censurarPalabra(texto = false, palabra = false) {
    ...
    if (!texto && !palabra) return "No se puede realizar la operación si no se ha definido el texto y la palabra a censurar";
...
console.log(censurarPalabra("hola pali?ndromo ojo pali|ndromo pero peroo", "palindromo"))


function censurarPalabra2(texto2 = false, palabra2 = false) {
    palabra2 = palabra2.toLowerCase()
    if (!texto2 && !palabra2) return "No se puede realizar la operación si no se ha definido el texto y la palabra a censurar";
